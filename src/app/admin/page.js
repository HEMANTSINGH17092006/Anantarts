...
export default async function AdminDashboardPage() {
  try {
    ...
    try {
      ...
      console.error('[AdminDashboardPage] DB query exception:', err);
    }
    ...
    const paidOrders = orders.filter(o => o && (o.payment_status === 'Captured' || o.payment_status === 'Paid' || o.payment_method === 'COD'));
    ...
    const failedPaymentsCount = orders.filter(o => o && (o.payment_status === 'Failed' || o.payment_status === 'Refunded' || o.payment_status === 'Authorized')).length;

    // Low Stock Items (< 5)
    const lowStockProducts = products.filter(p => p && typeof p.stock_quantity === 'number' && p.stock_quantity < 5);
    ...
    // 3. Monthly Sales Trends SVG Data (Deterministic 1st of Month)
    ...
    orders.forEach(o => {
      if (o && (o.payment_status === 'Captured' || o.payment_status === 'Paid' || o.payment_method === 'COD') && o.created_at) {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
        ...
        {/* 5 Enterprise Metric Glass Cards */}
        <div style={{
          display: 'grid',
        ...
        {/* Analytics Row: Sales Graph & Best Sellers Ranking */}
