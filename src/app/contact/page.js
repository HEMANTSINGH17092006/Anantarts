...
export const metadata = constructMetadata({
  title: 'Contact Anant Arts | Customer Support & Jaipur Studio Inquiries',
  description: 'Connect with Anant Arts for custom deity idol sizing, bulk corporate quotes, order tracking assistance, and Jaipur foundry studio visits.',
  canonical: '/contact',
});
