              ...
              <div key={order.id} style={{ border: '1px solid #EAEAEA', borderRadius: '12px', overflow: 'hidden' }}>
                ...
                <div style={{ padding: '24px 20px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px', marginBottom: '16px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      <div style={{ 
                        ...
                        fontSize: '0.75rem', 
                        fontWeight: '700', 
                        background: isCancelled ? '#FFCDD2' : (order.order_status === 'Delivered' ? 'rgba(46,125,50,0.1)' : 'rgba(212,175,55,0.1)'), 
                        color: isCancelled ? '#B71C1C' : (order.order_status === 'Delivered' ? '#2E7D32' : 'var(--primary-gold-hover)'),
                  ...
                  {isCancelled && order.cancellation_reason && (
                    <div style={{ background: '#FFEBEE', color: '#C62828', padding: '10px 14px', borderRadius: '6px', fontSize: '0.8rem', marginBottom: '16px' }}>
